...
import { ListFilter, Plus, Search, Workflow } from 'lucide-react';
...
export function DealsHeaderActions({ onCreate, onOpenFilters, activeFilterCount, searchValue, onSearchChange, funnels, selectedFunnelId, onSelectFunnel, t }: Props) {
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
        <div className="relative w-full xl:max-w-md">
          ...
          <Input value={searchValue} onChange={(event) => onSearchChange(event.target.value)} placeholder={t('deals.searchPlaceholder')} className="h-11 rounded-xl bg-card pl-9" />
        </div>
