...
import { formatFunnelChartData } from '@/widgets/dashboard/lib/formatFunnelChartData';

const BarChartComponent = dynamic(() => import('@/widgets/dashboard/ui/BarChartInner'), {
  ssr: false,
...
export function FunnelChart({ data }: { data: any[] }) {
  ...
  const chartData = formatFunnelChartData(data, t);
