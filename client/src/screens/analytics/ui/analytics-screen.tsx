...
import { getAnalyticsExtended } from '@/entities/analytics';
import { getLeads } from '@/entities/lead';
import { getPeriodDates, type Period } from '@/widgets/analytics/model/period';
import dynamic from 'next/dynamic';

const ConversionChart = dynamic(() => import('@/widgets/analytics/ui/conversion-chart'), { ssr: false });
const SourceChart = dynamic(() => import('@/widgets/analytics/ui/source-chart'), { ssr: false });
...
export function AnalyticsClient() {
  ...
  const fetchData = useCallback(() => {
    ...
    Promise.all([
      getDashboardStats(),
      getAnalyticsExtended(from, to),
getLeads({ search: undefined, status: undefined, source: undefined, managerId: undefined }).then((all) => {
