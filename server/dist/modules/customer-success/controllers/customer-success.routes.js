...
const customer_success_schemas_1 = require("./customer-success.schemas");
...
router.put('/aftercare-plans', (0, middleware_1.validateBody)(customer_success_schemas_1.reorderAftercarePlansSchema), async (req, res) => {
    res.json(await (0, aftercare_service_1.reorderAftercarePlans)(req.body));
});
router.post('/aftercare-plans', (0, middleware_1.validateBody)(customer_success_schemas_1.createAftercarePlanSchema), async (req, res) => {
    res.status(201).json(await (0, aftercare_service_1.addAftercarePlan)(req.body));
});
router.put('/aftercare-plans/:id', (0, middleware_1.validateBody)(customer_success_schemas_1.updateAftercarePlanSchema), async (req, res) => {
