...
function AutomationDialog({ automation, onSave, onClose, t, triggers, actions }: { automation: any; onSave: (d: any) => void; onClose: () => void; t: (k: string) => string; triggers: any[]; actions: any[] }) {
